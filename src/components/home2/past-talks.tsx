...
/**
 * A few recorded talks as a list, each led by its title and dated by the year
 * it was given — so the section reads as an archive to watch, not as a lineup
    ...
    <ul className="border-t border-rule">
      {speakers.map((speaker) => {
        ...
        const content = (
          <>
            {speaker.headshot && (
              <span className="relative size-14 shrink-0 overflow-hidden bg-ink-900 md:size-16">
                <Image
